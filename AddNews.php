...
if (isset($titre)){
    ...
    if (!in_array(strtolower(substr($_FILES['img']['name'], -3)), $extension)) {
        ...
        if (move_uploaded_file($_FILES['img']['tmp_name'], $path)) {
          $ss->create(new Actualite(1,$titre, $description, $date,$_FILES['img']['name']));
				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Actualités</span> </h4>
						</div>
					...
					<div class="breadcrumb-line breadcrumb-line-component">
						<ul class="breadcrumb">
							...
							<li><a href="form_inputs_basic.html">Actualités</a></li>
							<li class="active">Nouvelle Actualité</li>
						</ul>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Ajouter une actualité</h5>
