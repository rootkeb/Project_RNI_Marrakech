...
include_once 'Classe/Actualite.php';
include_once RACINE_PATH.'/service/ActualiteService.php';
				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Actualites</span> </h4>
						</div>
					...
					<div class="breadcrumb-line breadcrumb-line-component">
						<ul class="breadcrumb">
							...
							<li><a href="form_inputs_basic.html">Actualites</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Ajout une actualite</h5>
...
?>   
	...
	<button type="button" class="btn btn-default btn-icon btn-rounded legitRipple"  data-toggle="modal" data-target="#modal_form_Consulter<?php echo $v->getIdact();  ?>" data-popup="tooltip" title="" data-placement="top" id="left1" data-original-title="Consulter"><i class="icon-file-eye"></i></button>
	<button type="button" class="btn btn-success btn-icon btn-rounded legitRipple"  data-toggle="modal" data-target="#modal_form_Modifier<?php echo $v->getIdact();  ?>" data-popup="tooltip" title=""   data-placement="top"  id="left3" data-original-title="Modifier"><i class="icon-pencil7"></i></button></a>
	<button type="button" class="btn btn-default btn-icon btn-rounded legitRipple" data-toggle="modal" data-target="#modal_form_Supprimer<?php echo $v->getIdact();  ?>" data-popup="tooltip" title="" data-placement="top" id="left2" data-original-title="Supprimer"><i class="icon-close2"></i></button>
	...
	<!-- /default modal -->											
		...
		<div id="modal_form_Consulter<?php echo $v->getIdact();  ?>" class="modal fade">
						...
						<div class="modal-content">
							<div class="modal-header bg-info">
								...
								<div class="modal-body">
									...
									<div class="col-sm-12">
										<ul class="list list-unstyled text-left">
											<li>Desc:</li><span class="text-semibold"><?php echo $v->getDescription();  ?></span>
				...
				<!-- /default modal -->	
														...
														<!-- Vertical form modal -->
					<div id="modal_form_Modifier<?php echo $v->getIdact();  ?>" class="modal fade">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<form action="ListNews.php" method="POST" class="form-horizontal">
                                                                            <input type="hidden" value="<?php echo $v->getIdact();  ?>" name="idm" />
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
                                                                                                    <textarea name="description" class="form-control" ><?php echo $v->getDescription();  ?> </textarea> 
												</div>
											</div>
												<div class="form-group">
										...
										<div class="modal-footer">
											...
											<button type="submit" class="btn bg-primary-800">Modifier</button>
													...
													<!-- /vertical form modal -->
													 ...
													 <!-- Mini modal -->
				<div id="modal_form_Supprimer<?php echo $v->getIdact();  ?>" class="modal fade">
					<div class="modal-dialog modal-xs">
						<div class="modal-content">
							...
							<div class="modal-footer">
								...
								<a href="ListNews.php?id=<?php echo $v->getIdact(); ?>"><button type="button" class="btn btn-danger" value="Confirmer">Confirmer</button></a>
