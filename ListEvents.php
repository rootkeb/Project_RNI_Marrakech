...
include_once 'Classe/Evenement.php';
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title">
                        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Evénements</span> </h4>
                    </div>
                ...
                <div class="breadcrumb-line breadcrumb-line-component">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="form_inputs_basic.html">Evénements</a></li>
            ...
            <div class="content">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Liste des événements</h5>
                                    ...
                                    foreach($a as $v):{
                                        ...
                                        <tr role="row" th:each="m,rowStat : ${listeFactures}" th:class="${rowStat.even}? 'odd' : 'even'" class="odd">
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-default btn-icon btn-rounded legitRipple"  data-toggle="modal" data-target="#modal_form_Consulter<?php echo $v->getIdeevn();  ?>" data-popup="tooltip" title="" data-placement="top" id="left1" data-original-title="Consulter"><i class="icon-file-eye"></i></button>
                                                <button type="button" class="btn btn-success btn-icon btn-rounded legitRipple"  data-toggle="modal" data-target="#modal_form_Modifier<?php echo $v->getIdeevn();  ?>" data-popup="tooltip" title=""   data-placement="top"  id="left3" data-original-title="Modifier"><i class="icon-pencil7"></i></button></a>
                                                <button type="button" class="btn btn-default btn-icon btn-rounded legitRipple" data-toggle="modal" data-target="#modal_form_Supprimer<?php echo $v->getIdeevn();  ?>" data-popup="tooltip" title="" data-placement="top" id="left2" data-original-title="Supprimer"><i class="icon-close2"></i></button>
                                            ...
                                            <div id="modal_form_Consulter<?php echo $v->getIdeevn();  ?>" class="modal fade">
                                            ...
                                            <!-- Vertical form modal -->
                                            <div id="modal_form_Modifier<?php echo $v->getIdeevn();  ?>" class="modal fade">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="ListEvents.php" method="POST" class="form-horizontal">
                                                            <input type="hidden" value="<?php echo $v->getIdeevn();  ?>" name="idm" />
                                            ...
                                            <!-- Mini modal -->
                                            <div id="modal_form_Supprimer<?php echo $v->getIdeevn();  ?>" class="modal fade">
                                                <div class="modal-dialog modal-xs">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="ListEvents.php?id=<?php echo $v->getIdeevn(); ?>"><button type="button" class="btn btn-danger" value="Confirmer">Confirmer</button></a>
